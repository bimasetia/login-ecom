  ...
  <body>
    ...
    <section class="content">
      ...
      <div class="container">
        ...
        <form id="user">
          <table class="table table-hover">
            <tbody>
              ...
              <tr>
                <td><label for="djoined">Date Joined: </label></td><td><a>01-11-2020</a></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><input type="text" name="usrname" value="John" /></td>
              </tr>
              <tr>
                <td><label for="email">Email: </label></td>
                <td><input type="text" name="email" value="john@me.com" /></td>
              </tr>
              <tr>
                <td><label for="accesslevel">Access Level: </label></td>
                <td><input type="text" name="accesslevel" value="Assistant" /></td>
              </tr>
              <tr>
        ...
        <br><br>
        <h2>John's Account History</h2><br>
